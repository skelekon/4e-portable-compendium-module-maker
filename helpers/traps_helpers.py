...
def create_trap_library(id_in, tier_list, name_in):
    ...
    for t in tier_list:
        ...
        xml_out += (f'\t\t\t\t\t\t<recordname>traplists.traps{class_camel}{tier_camel}@{settings.library}</recordname>\n')
        xml_out += ('\t\t\t\t\t</librarylink>\n')
        xml_out += (f'\t\t\t\t</{lib_id}-traps{class_camel}>\n')
...
def create_trap_table(list_in, tier_list, name_in):
    xml_out = ''
    ...
    for t in tier_list:
        ...
        xml_out += (f'\t\t<traps{class_camel}{tier_camel}>\n')
